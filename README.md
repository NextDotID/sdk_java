...
- [x]  [Proof Service](https://docs.next.id/proof-service/ps-intro)
- [x]  [KV Service](https://docs.next.id/kv-service/kv-intro)
...
<repositories>
    <repository>
        ...
        <url>https://github.com/nextdotid/sdk_java.git</url>
    </repository>
</repositories>
```
...
//get stagenv kv service
KVClient devClient = KVClient.getStagClient();
//get prodenv proof service client 
